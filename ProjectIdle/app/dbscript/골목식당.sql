...
ALTER TABLE PLAYER_RECIPE ADD FOREIGN KEY (PLAYER_NAME) REFERENCES PLAYER (PLAYER_NAME);
ALTER TABLE PLAYER_RECIPE ADD FOREIGN KEY (RECIPE_NO) REFERENCES RECIPE (RECIPE_NO);
...
ALTER TABLE RECIPE_INGRE ADD FOREIGN KEY (INGRE_NO) REFERENCES INGRE (INGRE_NO);
ALTER TABLE RECIPE_INGRE ADD FOREIGN KEY (RECIPE_NO) REFERENCES RECIPE (RECIPE_NO);
...
ALTER TABLE STORAGE ADD FOREIGN KEY (PLAYER_NAME) REFERENCES PLAYER (PLAYER_NAME);
ALTER TABLE STORAGE ADD FOREIGN KEY (INGRE_NO) REFERENCES INGRE (INGRE_NO);
...
ALTER TABLE PLAYER_STORE ADD FOREIGN KEY (PLAYER_NAME) REFERENCES PLAYER (PLAYER_NAME);
ALTER TABLE PLAYER_STORE ADD FOREIGN KEY (STORE_LEVEL) REFERENCES STORE (STORE_LEVEL);